...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Complaints', href: '#complaints', icon: FileText, id: 'complaints' },
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-30 w-64 bg-slate-900 transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
